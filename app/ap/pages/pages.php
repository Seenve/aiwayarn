	    ...
	    <div class="row">
	        <div class="col-lg-12 d-flex">
				<form class="flex ajax" method="POST">
	                ...
	                <div class="form-group">
	                    <label class="form-label">Название (лат.)</label>
	                    <input type="text" class="form-control" name="name" value="<? echo $row['name']; ?>" required>
	                </div>
				...
				?>
	                ...
	                <div class="form-group">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu">
								<div class="card-body border-left-3 border-left-danger">
								Изменить невозможно, данная категория используется страницами:<br>
								<?php
									while($rown = mysqli_fetch_assoc($queryn)) {
										echo '(#'.$rown['id'].') <a href="/ap/?page='.$page.'&id='.$rown['id'].'" data-pjax="content">'.$rown['title'].'</a><br>';
									}
