            ...
            <div class="table-responsive border-bottom">
                <table class="table mb-0">
                    ...
                    <?php
                        ...
                        function apCategories($parentID, $parentName) {
                                ...
                                while($row = mysqli_fetch_array($result)) {
                                    ?>
                                        <tr data-id="<? echo $row['id']; ?>">
                                            <td>
                                                <div class="media align-items-center" style="padding-left: 30px;">
                                                    <a href="/ap/?page=products_category&id=<?php echo $row['id']; ?>" class="avatar avatar-md mr-3" data-pjax="content">
                                                        <?php 
                                                    ...
                                                    <div class="media-body">
                                                        <a href="/ap/?page=products_category&id=<?php echo $row['id']; ?>" class="js-lists-values-employee-name" data-pjax="content"><? echo $row['title']; ?></a><br>
                                                        <small class="text-muted js-lists-values-employee-title">Обновлено <?php echo showDate(strtotime($row['updatedate'])); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-right ">
                                                <div class="dropup">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="/ap/?page=products_category&id=<?php echo $row['id']; ?>" class="dropdown-item" data-pjax="content">Изменить</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
