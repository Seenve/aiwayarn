	        ...
	        <div class="col-lg-12 d-flex">
				<form class="flex ajax" method="POST">
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" class="form-control" name="h1" value="<? echo $row['h1']; ?>">
	                </div>
	                <div class="form-group">
	                    <label class="form-label">H2</label>
	                    <input type="text" class="form-control" name="h2" value="<? echo $row['h2']; ?>">
	                </div>
	                <div class="form-group">
	                    <label class="form-label">H3</label>
	                    <input type="text" class="form-control" name="h3" value="<? echo $row['h3']; ?>">
	                </div>
	                <div class="form-group">
	                    <label class="form-label">H4</label>
	                    <input type="text" class="form-control" name="h4" value="<? echo $row['h4']; ?>">
	                </div>
	                <div class="form-group">
	                    <label class="form-label">H5</label>
	                    <input type="text" class="form-control" name="h5" value="<? echo $row['h5']; ?>">
	                </div>
	                <div class="form-group">
	                    <label class="form-label">H6</label>
	                    <input type="text" class="form-control" name="h6" value="<? echo $row['h6']; ?>">
	                </div>

	                <div class="form-group">
	                    <label class="form-label">Блок текста 1</label>
	                    <textarea class="form-control" name="text1"><? echo $row['text1']; ?></textarea>
	                </div>
	                <div class="form-group">
	                    <label class="form-label">Блок текста 2</label>
	                    <textarea class="form-control" name="text2"><? echo $row['text2']; ?></textarea>
	                </div>
	                <div class="form-group">
	                    <label class="form-label">Блок текста 3</label>
	                    <textarea class="form-control" name="text3"><? echo $row['text3']; ?></textarea>
	                </div>
	                <div class="form-group">
	                    <label class="form-label">Блок текста 4</label>
	                    <textarea class="form-control" name="text4"><? echo $row['text4']; ?></textarea>
	                </div>
	                <div class="form-group">
	                    <label class="form-label">Блок текста 5</label>
	                    <textarea class="form-control" name="text5"><? echo $row['text5']; ?></textarea>
	                </div>
	                <div class="form-group">
	                    <label class="form-label">Блок текста 6</label>
	                    <textarea class="form-control" name="text6"><? echo $row['text6']; ?></textarea>
	                </div>
	                <div class="form-group">
	                    <label class="form-label">Блок текста 7</label>
	                    <textarea class="form-control" name="text7"><? echo $row['text7']; ?></textarea>
	                </div>
	                <div class="form-group">
	                    <label class="form-label">Блок текста 8</label>
	                    <textarea class="form-control" name="text8"><? echo $row['text8']; ?></textarea>
	                </div>
		        ...
		        <div class="card">
		        	<div class="cart-body">
						<!--<a data-pjax="content" href="/ap/?page=<?php echo $page; ?>&id=<?php echo $arr[$in]['id']; ?>" class="img">
							<?php
								/*if(gallery_arr($page, $idstr)['0']['image']) {
									?>
										<img src="<?php echo $uploads.'small/'.gallery_arr($page, $idstr)['0']['image']; ?>" alt="<?php echo $arr[$in]['title']; ?>">
									<?
								} else {
									?>
						...
						<div class="card-body">
				            <h4 class="card-title">Экран <?php echo $arr[$in]['id']; ?></h4>
							<div class="row-info">
								<!--<div class="str">
