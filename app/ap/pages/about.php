	    ...
	    <div class="row">
	        <div class="col-lg-12 d-flex">
				<form class="flex ajax" method="POST">
	                ...
	                <div class="form-group">
	                    <label class="form-label">Сайт [URL]</label>
	                    <input type="text" class="form-control" name="url" value="<? echo $row['site']; ?>">
	                </div>
		        	...
		        	<div class="cart-body">
						...
						<div class="card-body">
							...
							<div class="row-info">
								...
								<div class="str">
									<div>Лайков</div>
									<div class="text"><?php echo $arr[$in]['likes']; ?></div>
								</div>
								<div class="str">
									<div>Тип</div>
									<div class="text"><?php echo $typeportfolio_arr[$arr[$in]['type']]; ?></div>
								</div>
							</div>
						</div>
		        	</div>
